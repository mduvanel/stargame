...
public class BattleDialog implements ISavable
{
	protected static class Dialog implements ISavable
	{
		...
		{
			Bundle oObjectBundle = SavableHelper.retrieveBundle( oGlobalMap, strObjKey, Dialog.class.getName() );
	...
	{
		Bundle oObjectBundle = SavableHelper.retrieveBundle( oGlobalMap, strObjKey, BattleDialog.class.getName() );
		...
		SavableHelper.loadCollectionFromMap( oDialog.mVecDialogs, astrIds, oGlobalMap, new Dialog() );
