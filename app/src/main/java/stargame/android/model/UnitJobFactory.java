...
public class UnitJobFactory implements ISavable
{
    ...
    public UnitJob loadState( Bundle oGlobalMap, String strObjKey )
    {
        ...
        if ( ( oJob = UnitJobArcher.loadState( oGlobalMap, strObjKey ) ) != null )
        {
            return oJob;
        }
        if ( ( oJob = UnitJobBarbarian.loadState( oGlobalMap, strObjKey ) ) != null )
        {
            return oJob;
        }
        if ( ( oJob = UnitJobMage.loadState( oGlobalMap, strObjKey ) ) != null )
        {
            return oJob;
        }
        if ( ( oJob = UnitJobPriest.loadState( oGlobalMap, strObjKey ) ) != null )
        {
            return oJob;
        }
        if ( ( oJob = UnitJobRogue.loadState( oGlobalMap, strObjKey ) ) != null )
        {
            return oJob;
        }
        if ( ( oJob = UnitJobSoldier.loadState( oGlobalMap, strObjKey ) ) != null )
        {
            return oJob;
        }
        if ( ( oJob = UnitJobOracle.loadState( oGlobalMap, strObjKey ) ) != null )
        {
            return oJob;
        }
