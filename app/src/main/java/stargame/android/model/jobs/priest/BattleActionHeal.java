...
public class BattleActionHeal extends RangeBattleAction implements ISavable
{
	...
	public void ExecuteAction()
	{
		...
		dHeal = RandomGenerator.GetInstance().GetRandom( dHeal - ( dHeal / 10.0 ), dHeal + ( dHeal / 10.0 ) );
	...
	{
		Bundle oObjectBundle = SavableHelper.retrieveBundle( oGlobalMap, strObjKey, BattleActionHeal.class.getName() );
