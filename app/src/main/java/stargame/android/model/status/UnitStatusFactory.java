...
public class UnitStatusFactory implements ISavable
{
	...
	public UnitStatus loadState( Bundle oGlobalMap, String strObjKey )
	{
		...
		if ( ( oStatus = UnitStatusBarrier.loadState( oGlobalMap, strObjKey ) ) != null ) { return oStatus; }
		if ( ( oStatus = UnitStatusInvisible.loadState( oGlobalMap, strObjKey ) ) != null ) { return oStatus; }
		if ( ( oStatus = UnitStatusPoison.loadState( oGlobalMap, strObjKey ) ) != null ) { return oStatus; }
