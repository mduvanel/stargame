...
public class SavableHelper
{
	...
	public static < T extends ISavable > String [] saveCollectionInMap( Collection< T > colSavable, Bundle oGlobalMap )
	{
	...
	public static < T extends ISavable > void loadCollectionFromMap( Collection< T > colSavable, String [] astrIds, Bundle oGlobalMap, T oTmpInstance )
	{
		colSavable.clear();
	...
	public static < T extends ISavable > String [] saveArrayInMap( ISavable[] aSavables, Bundle oGlobalMap )
	{
	...
	public static < T extends ISavable > Bundle saveBidimensionalArrayInMap( ISavable[][] aSavables, Bundle oGlobalMap )
	{
	...
	@SuppressWarnings("unchecked")
	public static < T extends ISavable > void loadBidimensionalArrayFromMap( T [][] aSavables, Bundle oObjectMap, Bundle oGlobalMap, T oTmpInstance )
	{
		for ( int i = 0; i < aSavables.length; ++i )
		{
	...
	public static < T extends ISavable > Bundle saveTreeInMap( Tree< T > oSavableTree, Bundle oGlobalMap )
	{
	...
	private static < T extends ISavable > void saveTreeNodeInMap( TreeNode< T > oNode, Bundle oObjectMap, Bundle oGlobalMap )
	{
	...
	public static < T extends ISavable > Tree< T > loadTreeFromMap( Bundle oObjectMap, Bundle oGlobalMap, T oTmpInstance )
	{
	...
	@SuppressWarnings("unchecked")
	private static < T extends ISavable > TreeNode< T > loadTreeNodeFromMap( Bundle oObjectMap, Bundle oGlobalMap, T oTmpInstance )
	{
		...
		else
		{
			...
			do
			{
				...
				{
					TreeNode< T > oChildNode = loadTreeNodeFromMap( oChildBundle, oGlobalMap, oTmpInstance );
	...
	public static Bundle retrieveBundle( Bundle oMap, String strObjKey, String strClassName )
	{
		...
		Logger.e( String.format( "Failed to find bundle for instance %s of class %s", strObjKey, strClassName ) );
		return null;
	}
}
