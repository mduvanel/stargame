...
public class Position implements ISavable
{
     ...
     */
    static public Position OffsetPositionAbsolute( Position oPos, Orientation oOrientation, int iOffsetX, int iOffsetY )
    {
    	int iTmp;
    	switch ( oOrientation )
    	{
     ...
     * @return Offset position
     */
    static public Position OffsetPositionRelative( Position oPos, Orientation oOrientation, int iOffsetX, int iOffsetY )
    {
    	int iTmp;
    	switch ( oOrientation )
    	{
	...
	{
		Bundle oObjectBundle = SavableHelper.retrieveBundle( oGlobalMap, strObjKey, Position.class.getName() );
