...
public class Battle2D implements Observer
{
	...
	public Battle2D( Battle oBattle, Context oContext )
	{
		...
		{
			BattleUnit2D oUnit2D = new BattleUnit2D( oUnit, oContext, BattleField2D.GetInstance().GetDrawableList() );
	...
	public void update( Observable oObs, Object oObj )
	{
		if ( oObs instanceof BattleAction )
		{
			...
			case STATE_EXECUTING:
				...
				{
					mCurrentBattleAction = BattleAction2DFactory.GetInstance().BattleAction2DCreate( mBattle.GetCurrentAction(), this );
	...
	public void UpdateDialogs()
	{
		...
		if ( oCurDialog != null && oCurDialog.HasChanged() )
		{
			...
			{
				Bitmap oPortrait = GetBattleUnit2D( oCurDialog.GetCurrentDialogUnit() ).GetPortraitBitmap();
