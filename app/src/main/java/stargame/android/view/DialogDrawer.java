...
public class DialogDrawer
{
    ...
    public DialogDrawer( Resources oRes )
    {
        ...
        mTextDrawable = new NinePatchDrawable( oRes, oButtonBitmap, aChunk,
    ...
    public void DrawPortrait( Canvas oCanvas )
    {
        if ( mPortraitBitmap != null )
        {
            ...
            mDrawRect.offset( mTextDrawable.getMinimumWidth() / 2,
                              mTextDrawable.getMinimumHeight() / 2 );
            ...
            while ( oTokenizer.hasMoreTokens() )
            {
                ...
                if ( mDrawRect.width() > iAvailableWidth )
                {
                    ...
                    if ( mDrawRect.width() > iAvailableWidth )
                    {
                        ...
                        do
                        {
                            String strStart = strWord.substring( 0, ( int ) Math.ceil(
                                    ( double ) strWord.length() / ( double ) iSplitFactor ) );
                            ...
                            else
                            {
                                ...
                                {
                                    String strSplit = strWord.substring( iStartPos,
                                                                         ( i + 1 ) * iWordLength );
