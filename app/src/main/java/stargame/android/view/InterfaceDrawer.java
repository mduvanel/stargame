...
public class InterfaceDrawer
{
	...
	public InterfaceDrawer( Context oContext, BattleView2D oBattleView, Battle2D oBattle )
	{
    	...
    	mButton = new NinePatchDrawable( oContext.getResources(), oButtonBitmap, aChunk, new Rect( 7, 7, 17, 17 ), null );
    	...
    	mSelectedButton = new NinePatchDrawable( oContext.getResources(), oButtonBitmap, aChunk, new Rect( 7, 7, 17, 17 ), null );
	...
	public void DrawHorizontal9Patch( Canvas oCanvas, NinePatchDrawable o9Patch, String strText, int iHeightBitmap )
	{
		if ( strText.length() > 0 )
		{
	...
	public void DrawVertical9Patch( Canvas oCanvas, NinePatchDrawable o9Patch, String strText, int iWidthBitmap )
	{
		if ( strText.length() > 0 )
		{
			// First get dimensions for the text
	...
	public void DrawHorizontalButton( Canvas oCanvas, Bitmap oBitmap, String strText, int iHeightBitmap, int iHeightText )
	{
		if ( strText.length() > 0 )
		{
			oCanvas.drawBitmap( 
	...
	public void DrawVerticalButton( Canvas oCanvas, Bitmap oBitmap, String strText, int iWidthBitmap, int iWidthText )
	{
		if ( strText.length() > 0 )
		{
	...
	public void DrawPortrait( Canvas oCanvas )
	{
		...
		if ( oCellUnit != null )
		{
			...
			mDrawRect.offset( iMargin + ( mLifebar.getWidth() - oPortrait.getWidth() ) / 2, mHeight - oPortrait.getHeight() - mLifebar.getHeight() - iMargin );
			...
			mLifebarPaint.setARGB( 192, Math.min( 511 - iColorRatio, 255 ), Math.min( 255, iColorRatio ), 0 );
